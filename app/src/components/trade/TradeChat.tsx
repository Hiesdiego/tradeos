...
export function TradeChat({
      ...
      if (!res.ok) {
        const apiError =
          ...
          typeof (payload as { error?: unknown }).error === "string"
            ...
            : `Messages endpoint failed (${res.status})`;
  ...
  }, [tradeId, disablePolling]); // tradeId is the only real dependency
  ...
  }, [fetchMessages, disablePolling]); // fetchMessages only changes when tradeId changes
  ...
  return (
    <div className="trade-card glass-panel flex flex-col" style={{ minHeight: "420px" }}>
