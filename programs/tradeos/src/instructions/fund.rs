...
pub fn handler(ctx: Context<FundEscrow>, amount: u64, expected_nonce: u64) -> Result<()> {
    let escrow = &mut ctx.accounts.escrow;
    require!(expected_nonce == escrow.fund_nonce, TradeOSError::InvalidNonce);
