...
pub fn handler(ctx: Context<ReleaseMilestone>, milestone_index: u8, expected_nonce: u64) -> Result<()> {
    ...
    require!(expected_nonce == escrow.release_nonce, TradeOSError::InvalidNonce);
